...
@interface TDGGameKitHelper ()<GKGameCenterControllerDelegate>

@end

@implementation TDGGameKitHelper
{
...
{
    static TDGGameKitHelper *sharedGameKitHelper;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        sharedGameKitHelper = [[TDGGameKitHelper alloc]init];
    });
...
-(void)setLastError:(NSError *)error
{
    ...
    if (_lastError) {
        NSLog(@"TDGGameKitHelper ERROR: %@", [[_lastError userInfo]description]);
    }
}
